...
class RobertaPreTrainedModel(PreTrainedModel):
    ...
    def init_weights(self, module):
        ...
        elif isinstance(module, RobertaLayerNorm) or isinstance(module, LayerNormClass):
...
class RobertaImgModel(RobertaPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        print('RobertaImgModel Image Dimension: {}'.format(self.img_dim))
...
#Bert Model transformer for image captioning
class RobertaForImageCaptioning(RobertaPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # cclin
        self.cls_img_feat = RobertaIFPredictionHead(config)
