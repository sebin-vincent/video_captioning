from src.layers.roberta import RobertaTokenizer, RobertaConfig, RobertaForImageCaptioning
from src.utils.logger import LOGGER as logger

def get_roberta_model(args):
    # Load pretrained roberta and tokenizer based on training configs
    config_class, model_class, tokenizer_class = RobertaConfig, RobertaForImageCaptioning, RobertaTokenizer
    ...
    for idx, param in enumerate(update_params):
        ...
        # roberta-base do not have img_feature_dim
