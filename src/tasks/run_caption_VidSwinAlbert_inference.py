...
from src.modeling.video_captioning_e2e_vid_swin_transformer import VideoTransformer
...
def update_existing_config_for_inference(args):
    ...
    train_args.model_name_or_path = 'albert-large-v2'
